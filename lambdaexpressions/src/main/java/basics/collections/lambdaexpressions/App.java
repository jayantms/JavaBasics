...
public class App {
	public static void main(String[] args) {
		...
		List<Car> lsedancarList = lcarList.stream().filter(car -> car.getCarType().equals("Sedan")).collect(Collectors.toList());
		
		System.out.println("--------------------------------"); 
		
		lsedancarList.forEach(car -> System.out.println(car.toString()));
